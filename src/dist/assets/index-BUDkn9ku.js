(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))n(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function a(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(e){if(e.ep)return;e.ep=!0;const r=a(e);fetch(e.href,r)}})();const s=[{id:3,nombre:"Mahou Cinco Estrellas",tipo:"Lager",origen:"Madrid",descripcion:"Cerveza rubia, suave y refrescante con un sabor ligeramente amargo.",imagen:"https://d2j6dbq0eux0bg.cloudfront.net/images/62086137/2352696799.jpg"},{id:22,nombre:"Estrella Galicia",tipo:"Lager",origen:"Galicia",descripcion:"Cerveza suave y equilibrada con un sabor ligeramente amargo y aroma a malta.",imagen:"https://estrellagalicia.es/wp-content/uploads/2017/01/botella-estrella-galicia-especial.png"},{id:33,nombre:"Alhambra Reserva 1925",tipo:"Lager",origen:"Granada",descripcion:"Cerveza rubia con un sabor ligeramente dulce y toques de caramelo.",imagen:"https://sgfm.elcorteingles.es/SGFM/dctm/MEDIA03/202204/04/00118602800916____3__600x600.jpg"},{id:34,nombre:"San Miguel Especial",tipo:"Lager",origen:"Barcelona",descripcion:"Cerveza rubia, suave y refrescante con un sabor ligeramente amargo.",imagen:"https://www.sanmiguel.com/es/wp-content/uploads/sites/2/2021/01/san-miguel-gluten-free-4.png"},{id:35,nombre:"Damm Estrella",tipo:"Lager",origen:"Barcelona",descripcion:"Cerveza rubia, suave y refrescante con un sabor ligeramente amargo.",imagen:"https://static.damm.com/sites/default/files/config-page/estrella_header_logo/estrella-damm_0.png"}],c={template:`
    ...
    `,script:()=>{const o=document.querySelector("#cervezas");s.forEach(t=>{const a=document.createElement("option");a.text=t.nombre,a.value=t.id,o.appendChild(a)}),o.addEventListener("change",()=>{const t=s.find(a=>a.id==o.value);t&&(document.querySelector("#nombre").innerHTML=t.nombre,document.querySelector("#descripcion").innerHTML=t.descripcion,document.querySelector("#imagen").src=t.imagen)})}};let i=[];const l={template:`
    <div class="row">
    ...
    `,script:()=>{document.querySelector("#btnAñadir").addEventListener("click",o=>{o.preventDefault();const t=document.querySelector("#nombreGrupo").value,a=document.querySelector("#numeroMesa").value,n=document.querySelector("#cervezas").options[document.querySelector("#cervezas").selectedIndex].text,e=document.querySelector("#cantidad").value;i.push({id:i.length+1,numeroMesa:a,nombreGrupo:t,cerveza:n,cantidad:e,estado:"pendiente"}),console.log(i);const r=i[i.length-1];document.querySelector("#tbodyPedidos").innerHTML+=`
            ...
            `}),document.querySelector("#tbodyPedidos").addEventListener("click",o=>{if(o.target.id=="btnPendiente"){const t=o.target;t.classList.remove("btn-outline-warning"),t.classList.add("btn-outline-success"),t.innerHTML="Pedido servido"}if(o.target.id=="btnEliminar"){const t=o.target.closest("tr"),a=parseInt(t.dataset.pedido),n=i.filter(e=>e.id!=a);document.querySelector("#tbodyPedidos").innerHTML="",n.forEach(e=>{document.querySelector("#tbodyPedidos").innerHTML+=`
